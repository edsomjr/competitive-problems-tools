...
#define CP_TOOLS_ERROR_CPP_FILESYSTEM_REMOVE_DIRECTORY -63
#define CP_TOOLS_ERROR_CPP_FILESYSTEM_REMOVE_FILE -64
#define CP_TOOLS_ERROR_CPP_FILESYSTEM_EXISTS -65
