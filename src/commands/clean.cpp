...
static struct option longopts[] = {
    {"help", no_argument, NULL, 'h'}, {"working-dir", required_argument, NULL, 'w'}, {0, 0, 0, 0}};
...
int remove_autogenerated_files(const std::string &target, std::ostream &out) {
    logger::log(logger::INFO, "Cleaning autogenerated files...");
    ...
    if (not res1.ok and not res2.ok) {
        logger::log(logger::WARNING, "No autogenerated files found!");
        return CP_TOOLS_OK;
    }
...
int run(int argc, char *const argv[], std::ostream &out, std::ostream &err) {
    ...
    return remove_autogenerated_files(target, out);
}
} // namespace cptools::commands::clean
