...
namespace cptools::util
{
    ...
    static std::string
    strip(const std::string &s, const std::string &delim)
    {
    ...
    std::string
    lower_string(const std::string &s)
    {
    ...
    nlohmann::json
    read_json_file(const std::string &config_file_path)
    {
    ...
    std::string
    to_json_pointer(const std::string &s)
    {
        if (not s.length())
            return s;
     ...
     */
    std::string
    get_argv_value(std::string key, int argc, char *const argv[])
    {
     ...
     */
    std::string
    get_from_argv(int argc, char *const argv[], std::vector<std::string> keys,
