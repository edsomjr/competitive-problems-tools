...
namespace cptools::types::polygon
{
    ...
    void
    from_json(const nlohmann::json &j, Solution &s)
    {
    ...
    void
    from_json(const nlohmann::json &j, Statement &s)
    {
    ...
    void
    from_json(const nlohmann::json &j, Information &i)
    {
    ...
    void
    from_json(const nlohmann::json &j, Test &t)
    {
