...
namespace cptools::conflicts
{
    ...
    /**
     * @brief Deals with conflicts between the current and the new file. Returns the file path of
     * the new file.
     *
     ...
     */
    std::string
    solve_files(const std::string &local_file_name, const std::string &remote_file_name,
