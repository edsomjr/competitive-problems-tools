...
namespace cptools::cli
{
     ...
     */
    void
    set_error_stream(std::ostream &stream)
    {
        error_stream = &stream;
    }
     ...
     */
    void
    write(const fmt type, const std::string &message, bool is_error)
    {
     ...
     */
    void
    write_trace(const std::string &message)
    {
    ...
    /**
     * @brief Writes a formatted error message on stderr.
     *
    ...
    {
        cli::write(cli::fmt::error, text, true);
    }

    /**
     * @brief Writes a formatted trace message on stderr.
     *
     * @param text The message to write
     */
    void
    ...
    {
        cli::write(cli::fmt::trace, text, true);
    }
